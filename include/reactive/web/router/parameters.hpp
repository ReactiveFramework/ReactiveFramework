...
namespace router {
    ...
    template<>
    inline std::string parameters::get<std::string>(const std::string& key_) const
    {
        if ((*this).has(key_)) {
            return (*this).at(key_);
        }
    ...
    template<>
    inline int parameters::get<int>(const std::string& key_) const
    {
        if ((*this).has(key_)) {
    ...
    template<>
    inline int64_t parameters::get<int64_t>(const std::string& key_) const
    {
        if ((*this).has(key_)) {
    ...
    template<>
    inline double parameters::get<double>(const std::string& key_) const
    {
        if ((*this).has(key_)) {
